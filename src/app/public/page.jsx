                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 mt-3">
                            ...
                            <div className="flex-none w-2/3 max-w-full px-3">
                                <div>
                                    ...
                                    <div className="flex gap-2 absolute right-3 bottom-1">
                                        <label htmlFor="requirement-modal" className="flex gap-1 items-center badge badge-warning cursor-pointer" onClick={() => setFeature(1)}>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16"><path fill="#000000" fillRule="evenodd" d="M4 0a4 4 0 0 0-4 4v8a4 4 0 0 0 4 4h8a4 4 0 0 0 4-4V4a4 4 0 0 0-4-4H4zm0 4.75A.75.75 0 0 1 4.75 4h6.5a.75.75 0 0 1 0 1.5h-6.5A.75.75 0 0 1 4 4.75zm9.78 5.72a.75.75 0 0 1 0 1.06l-2.25 2.25a.75.75 0 0 1-1.06 0l-1.25-1.25a.75.75 0 1 1 1.06-1.06l.72.72l1.72-1.72a.75.75 0 0 1 1.06 0zM4 8a.75.75 0 0 1 .75-.75h6.5a.75.75 0 0 1 0 1.5h-6.5A.75.75 0 0 1 4 8zm0 3.25a.75.75 0 0 1 .75-.75h2.5a.75.75 0 0 1 0 1.5h-2.5a.75.75 0 0 1-.75-.75z" clipRule="evenodd"></path></svg>
                                            Syarat
                                        </label>
                    ...
                    <div className="flex-auto p-4 bg-base-300 rounded-lg relative">
                        <div className="flex flex-wrap -mx-3">
                            <div className="flex-none w-2/3 max-w-full px-3 ">
                                <div>
                                    <Link href={'/public/student-mutation'} >
                                        <div className="flex gap-1 items-center text-sm">
                    ...
                    <div className="flex-auto p-4 bg-base-300 rounded-lg relative">
                        <div className="flex flex-wrap -mx-3">
                            <div className="flex-none w-2/3 max-w-full px-3">
                                <div>
                                    <Link href={'/public/diploma-replacement'} >
                                        <div className="flex gap-1 items-center text-sm">
                    ...
                    <div className="flex-auto p-4 bg-base-300 rounded-lg relative">
                        <div className="flex flex-wrap -mx-3">
                            <div className="flex-none w-2/3 max-w-full px-3">
                                <div>
                                    <Link href={'/public/cultural-heritage'} >
                                        <div className="flex gap-1 items-center text-sm">
                    ...
                    <div className="flex-auto p-4 bg-base-300 rounded-lg relative">
                        <div className="flex flex-wrap -mx-3">
                            <div className="flex-none w-2/3 max-w-full px-3">
                                <div>
                                    <Link href={'/public/internship-recommendation'} >
                                        <div className="flex gap-1 items-center text-sm">
