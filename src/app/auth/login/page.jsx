      ...
      <main>
        ...
        <div className="relative min-h-screen flex ">
          <div className="flex flex-col sm:flex-row items-center md:items-start sm:justify-center md:justify-start flex-auto min-w-0 bg-white">
            ...
            >
              <div className="absolute bg-gradient-to-b from-green-950 to-green-600 opacity-75 inset-0 z-0" />
              ...
              <div className=" w-full space-y-8">
                ...
                <form className="mt-2 space-y-6" onSubmit={handleSubmit}>
                  ...
                  <div className="relative">
                    ...
                    <input
                      className=" w-full text-base px-4 py-2 border-b border-gray-300 focus:outline-none rounded-2xl focus:border-green-300"
                      required
                      id='email'
                  ...
                  <div className="mt-8 content-center">
                    ...
                    <input
                      className="w-full content-center text-base px-4 py-2 border-b rounded-2xl border-gray-300 focus:outline-none focus:border-green-300"
                      type="password"
                  ...
                  <div>
                    <button className="w-full flex justify-center bg-gradient-to-r from-green-300 to-green-600  hover:bg-gradient-to-l hover:from-green-500 hover:to-green-600 text-gray-100 p-4  rounded-full tracking-wide font-semibold  shadow-lg cursor-pointer transition ease-in duration-500" >
                      Login
                    </button>
                  </div>
