    ...
    return <>
        <main className={montserrat.className}>
            <div className="bg-base-200 h-screen">
                <div className="bg-gradient-to-r from-green-950 to-green-800 w-full h-64">
                    <div className="max-w-7xl mx-auto w-full flex justify-between relative p-2 md:p-2 lg:p-0">
                        ...
                        <div className="absolute top-0 md:top-10 right-0 flex items-center gap-2">
                ...
                <div className={isFullWidth ? 'bg-base-100 rounded-xl shadow-xl px-3 py-2 absolute w-full top-40  left-1/2 transform -translate-x-1/2' : 'bg-base-100 rounded-xl shadow-xl px-3 py-2 absolute max-w-7xl w-full top-40  left-1/2 transform -translate-x-1/2 md:mt-0'}>
