...
export default function NewPageLayout({ children, title, backURL = '#', hasBackURL, isFullWidth = false, isNativeBack = false }) {
    ...
    return <>
        <main className={montserrat.className}>
            <div className="bg-base-200 h-screen">
                <div className="bg-gradient-to-r from-sky-500 to-blue-500 w-full h-64">
                    <div className="max-w-7xl mx-auto w-full flex justify-between relative p-2 md:p-2 lg:p-0">
                            ...
                            <div className="dropdown dropdown-end">
                                <label tabIndex={0} className="btn btn-ghost btn-circle avatar">
                                    <div className="w-10 rounded-full">
                                        <Image src={process.env.API + '/' + storageService.getProfilePicture()} alt="photo" width={100} height={100} referrerPolicy="no-referrer" />
                                    </div>
                                </label>
                        ...
                        <div className="absolute top-10 w-full">
                            ...
                            <p className="text-white hidden md:block">{process.env.APP_DESC}</p>
                        </div>
                ...
                <div className={isFullWidth ? 'bg-base-100 rounded-xl shadow-xl px-3 py-2 absolute w-full top-52 md:top-40  left-1/2 transform -translate-x-1/2' : 'bg-base-100 rounded-xl shadow-xl px-3 py-2 absolute max-w-7xl w-full top-36 md:top-40  left-1/2 transform -translate-x-1/2 '}>
                    <div className="flex w-full justify-end">
                        <div className={`${hasBackURL && !isNativeBack ? '' : 'hidden'}`}>
                        ...
                        <div className={`${isNativeBack ? '' : 'hidden'}`}>
